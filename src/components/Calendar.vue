    ...
    <v-col>
      <v-sheet height="64">
        <v-toolbar flat color="white">
          <v-btn color="primary" class="mr-4" @click="dialog=true">Today</v-btn>
        ...
        <v-card>
          <v-container>
            <v-form @submit.prevent="addEvent">
              ...
              <v-text-field v-model="start" type="date" label="start (requried)"></v-text-field>
              <v-text-field v-model="color" type="color" label="start (requried)"></v-text-field>
        ...
        >
          <v-card color="grey lighten-4" min-width="350px" flat>
            ...
            <v-card-actions>
              ...
              >Edit</v-btn>
              <v-btn text color="success" v-else @click.prevent="saveEvent(selectedEvent)">Save</v-btn>
            </v-card-actions>
          </v-card>
        </v-menu>
      </v-sheet>
    ...
    async getEvents() {
      ...
      res.data.forEach(n => {
        let note = {
          ...
          name: n.content,
          details: n.detail,
          start: n.time.substring(0, 10),
          color: "#00aabb",
          end: n.time.substring(0, 10)
        };
        events.push(note);
      });
      this.events = events;
